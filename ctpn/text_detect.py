...
def ctpn(img):
    ...
    logging.info("resize_im时间", time.time() -sttime)
    scores, boxes = test_ctpn(sess, net, img)
    logging.info("test_ctpn", time.time() - sttime)
    textdetector = TextDetector()
    logging.info("load detector", time.time() - sttime)
